...
if(isset($_POST["Submit"]))
{
  ...
  elseif(strlen($PostTitle)>9999){
    ...
    Redirect_to("AddNewPost.php");
      ...
      // query to insert post inside database
      global $ConnectingDB;
      ...
      if($Execute){
      $_SESSION["SuccessMessage"]="Post with id ".$ConnectingDB->lastInsertId()." Added Suscessfully";
      Redirect_to("AddNewPost.php");
      }
      else {
...
<html lang="en" dir="ltr">
  ...
  <body background>
      ...
      <nav class = "navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a href="https://www.dr-ait.org" class="navbar-brand"> Ambedkar Institite Of Technology </a>
      ...
      <section class = "container py-2 mb-4">
         <div class="row">
           <div class="offset-lg-1 col-lg-10" style="min-height:500px;">
             ...
             echo SuccessMessage();
             ?>
            <form class="" action="AddNewPost.php" method="post" enctype="multipart/form-data"> <!--enctype for image to keep it in database-->
              <div class="card bg-secondary text-light mb-3">
                <div class="card-body bg-dark text-white">
                  <div class="form-group">
                    <label for="title"><span class = "FieldInfo">Post Title :</span> </label>
                    <input class = "form-control" type="text" name="PostTitle" id = "title" placeholder = "Type_title_here">
                  </div>
                  <div class="form-group">
        ...
        <div class="container">
          <div class="row">
            ...
            <p class = "text-center small"> <a style = "color :white; text-decoration: none; cursor : pointer;" href="#"></a>
              This site is for purpose to provide information in regard to tech talks and events being conducted at
